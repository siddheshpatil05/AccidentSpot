...
<style>
  body {
    background:linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7)),url('images/rd1.jpeg') no-repeat 0% 12% fixed;
...
<body class="layout-container ls-top-navbar si-l3-md-up">
  ...
  <div class="layout-content" data-scrollable="">
    <div class="container-fluid">
      ...
      <div class="card" style="width: 60%; margin-top:150px;margin-left:60px;border:2px solid white; background-color:transparent;">
            <div class="card-block">
            
            	<h2 class="sub-head" style="margin-left:50px;">Police LOGIN</h2>
             
              <form name="myform" action="AdvLogin" onsubmit="return validateUser()" method="post">
