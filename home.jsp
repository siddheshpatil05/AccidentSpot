...
<style>
  body {
    background:linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url('images/accident.jpg') no-repeat 0% 12% fixed;
    ...
    <div class="container-fluid">
      ...
      <div class="card" style="width: 60%; margin-top:150px;margin-left:60px;border:1px solid white; background-color:transparent;">
            <div class="card-block">
            	...
            	<h2 class="sub-head" style="margin-left:50px;">ADMIN LOGIN</h2>
             
              <form name="myform" action="adminlogin" onsubmit="return validateUser()" method="post">
