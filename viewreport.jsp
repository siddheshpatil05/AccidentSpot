    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
             ...
             <li>
                        <a class="active-menu" href="tmohome.jsp"><i class="fa fa-dashboard " style="font-size:20px;color:black"></i>TMO Home</a>
                    </li>
                    <li>
             			<a href="viewreport.jsp"><i class="fa fa-user" style="font-size:20px;color:white"></i>View Accident Report</a>
                         </li>
                	<li>
